...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            id='site-dropdown',  # Corrected the id
            options=[
    ...
    html.Div([
        ...
        dcc.RangeSlider(id='payload-slider',  # Corrected the id
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(spacex_df, names='class', title='Success Rate by Class')
        return fig
    else:
        fig = px.pie(filtered_df, names='class', title='Success Rate by Class')
        return fig
